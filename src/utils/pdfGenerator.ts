...
export const downloadPDFResults = (
  ...
  const drawTitle = () => {
    ...
    const introText = "Este manual representa las 8 fases completas del proceso de reestructuración mental y renovación espiritual. Contiene el diagnóstico de rumiaciones y mentiras carnales desmanteladas, las declaraciones ancladas en la Verdad Divina y la guía devocional de 30 días para forjar nuevas autopistas sinápticas de fe, paz y obediencia.";
